...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6f4efe7cf7079f52a814eba6e8dfe6e4) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("shell_support", None)
                        ];
                   ...
                   {
                      lib_modules =
                        ["Ocaml_profiles_constants"; "Arguments"; "Client"];
                      lib_pack = true;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "ocaml-profiles-client"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "ocaml_profiles.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\020\245T\1809\211\183\191^\182\209g`c\201@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
