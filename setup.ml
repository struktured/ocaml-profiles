...
(* OASIS_START *)
(* DO NOT EDIT (digest: d6d914f9b9a7debbe052619c04fb580a) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "ocaml_profiles_client"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\205\200\223\206\168\188\137\006\165\187[t\165\188O\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
